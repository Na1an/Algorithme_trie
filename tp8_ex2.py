...
# Les entiers de cette permutation sont represente par
# un type "str"
def permutation(n) :
...
def genererABR(per) :
    ...
    if per == None:
        return None
    res = [[per[0],1,2,0],[None,None,None,0],[None,None,None,0]]
    #res = [[per[0],None,None,0]]
    for i in range(1,len(per)):
        insertionABR(res,per[i])
    return res
